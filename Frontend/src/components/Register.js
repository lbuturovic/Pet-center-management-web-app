...
export const Register = () => {
  ...
  async function handleSubmit(event) {
    ...
    var url = 'http://localhost:8090/user/api/register';
    ...
    <div className="grid p-fluid" style={styles}>
      <div className="col-12 lg:col-6">
        ...
        <div className="text-center mb-5">
                        <h1 >Register</h1>
                        <span className="text-600 font-medium line-height-3">Already registered?</span>
                        <a href="/login" className="font-medium no-underline ml-2 text-blue-500 cursor-pointer">Login</a>
                    </div>
        ...
        <InputText
            ...
            <h5 htmlFor="password">
                ...
                <FontAwesomeIcon icon={faTimes} className={validMatch || !matchPwd ? "hide" : "invalid"} />
                        ...
                        <Button label="Register" icon="pi pi-user" style={styles3} onClick={handleSubmit}/>
