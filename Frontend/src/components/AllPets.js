...
const AllPets = () => {
    ...
    const url = "http://localhost:8090/main/api/pets";
    ...
    const moreButtonClicked = (data) => {
        let id = "?id=" + data.id;
        navigate({pathname:'/edit-pet', search: id });
    }
    ...
    const renderHeader = () => {
        ...
        const filterData = () => {
            ...
            (item.status.toLowerCase().includes(statusKey.toLowerCase()) || statusKey == 'ALL') &&
            ...
            <div style={{ textAlign: 'left' }}>
                ...
                <div className="grid">
                        ...
                        <div className="col-12 md:col-5">
                            ...
                            <div className="col-12 md:col-5">
                            <h5>Status</h5>
                            <Dropdown id = "age" options={statusOptions} value={statusKey} onChange={onStatusChange} placeholder="Sort By" />
                            </div>
                            <div className="col-12 md:col-5">
